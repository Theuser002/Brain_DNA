...
def impf_run(class_name, alg, fold, train_loader, val_loader, test_loader, model, criterion, optimizer, config, save):
    history = {'val_accs': [], 'val_losses': [], 'val_precisions': [], 'val_recalls': [], 'val_aucs': [], 'val_f1s':[], 'test_accs': [], 'test_losses': [], 'test_precisions': [], 'test_recalls': [], 'test_aucs': [], 'test_f1s': []}
    ...
    patience = 0
    selected_metrics = ['train_precision', 'train_recall', 'train_auc', 'train_f1','train_cfs', 'val_precision', 'val_recall', 'val_auc', 'val_f1' 'val_cfs', 'test_precision', 'test_recall', 'test_auc', 'test_f1', 'test_cfs']
